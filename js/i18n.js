...
export const STRINGS = {
  ...
  'logo.sub':        { fa: '۳۰ سطح · آزمون و نشان', en: '30 levels · quizzes & achievement' },
  ...
  'modal.text':      { fa: 'همهٔ سطح‌های قبول‌شده و پیشرفت تو پاک می‌شود و همه‌چیز از سطح ۱ شروع می‌شود. این کار برگشت‌پذیر نیست.', en: 'All passed levels and your progress are cleared, and everything starts again from level 1. This cannot be undone.' },
  ...
  'intro.start':        { fa: 'شروع از سطح ۱', en: 'Start at level 1' },
  ...
  'quiz.toast.done':    { fa: 'هر ۳۰ سطح کامل شد! نشان مسیر آماده است.', en: 'All 30 levels complete! Your path achievement is ready.' },
