...
<h3>ابزارهای کارت</h3>
<ul>
<li><strong>Code Editor:</strong> برای طراح، <strong>VS Code</strong> انتخاب استاندارد است؛ Git داخلش یکپارچه است و Diff و Conflict را بصری نشان می‌دهد.</li>
...
<p>هنگام ساخت Repo در GitHub سه انتخاب اولیه داری: نام و توضیح کوتاه، Public یا Private بودن، و افزودن فایل‌های شروع مثل README و <code>.gitignore</code>. برای پروژه‌های شخصی و تمرینی Private امن‌تر است.</p>
`,
quiz:[
...
<p>چون شناسه از محتوا ساخته می‌شود، تغییر یک بایت یعنی شیء کاملاً جدید؛ به همین دلیل تاریخچهٔ Git دستکاری‌ناپذیر است.</p>
...
{q:'چرا هش Commit با تغییر محتوا عوض می‌شود؟', o:['تصادفی است','چون هش از محتوای شیء محاسبه می‌شود، پس هر تغییری شیء جدیدی می‌سازد','چون تاریخ تغییر می‌کند','چون GitHub آن را عوض می‌کند'], a:1, why:'همین ویژگی، تاریخچهٔ Git را قابل‌راستی‌آزمایی و دستکاری‌ناپذیر می‌کند.'},
